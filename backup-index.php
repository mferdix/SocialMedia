          ...
          <div class="col s12 m8">
                  ...
                  <div class="col s12">
                    <div class="row">
                      <div class="input-field col s12">
                        <input autocomplete="off" type="text" id="cari" class="materialize-textarea" name="search">
            ...
            <div class="post-user all-post">
              <div class="header">
                <ul>  
                  <li>
                    <img src="images/profile-picture/<?= $data["profile-picture"]; ?>">
                  </li>
                  <li>
                    <ul>
                      <li><?= $data["nama"]; ?></li>
          ...
          <div class="col s12 m4">
          	<div class="side-right">
          		<div class="collection">
				        ...
				        <a href="my-all-post.php?username=<?= $_SESSION["username"]; ?>" class="collection-item"><span class="badge"></span>See You All Post</a>
				        <a href="../pkn/index.php" class="collection-item"><span class="badge"></span>About this App</a>
                <a href="logout.php" class="collection-item"><span class="badge"></span>Logout</a>
				      </div>
          	</div>
          </div>
        </div>
